package com.example.helloworldapp.exercises
...
Un valor de -1 para indicar que el precio no es válido cuando
un usuario ingresa una edad fuera de las especificaciones
* */
